...
import ProductPreviewModalSimple from "./ProductPreviewModalSimple.jsx"
...
const CATEGORIES = [
  { label: "Black Gold Vases", tag: "Luxe",      image: BlackGoldLargeVase,  nav: "vases" },
  { label: "Green Collection", tag: "Botanical", image: GreenGrainyLineVase, nav: "vases" },
  { label: "Marble Series",    tag: "Classic",   image: MarbleLineVase,      nav: "vases" },
]
  ...
  return (
    ...
    >
      <div
        ...
        style={{ backgroundColor: isDark ? "#0f172a" : "#f6f8f6" }}
      >
        <img
          src={product.image}
          alt={product.name}
        ...
        >
          ...
          <div className="text-center lg:text-left">
            ...
            <p
              ...
              style={{ color: subC }}
            >
              A good vase makes every bouquet better. Shop our range in different styles, sizes, and finishes for any space.
            </p>
