...
// ── Inline icons (stroke = currentColor so they recolor via the wrapper) ─────
// Scissors + hand-thumb-up use the official Heroicons outline paths (same set
// as Testimonials.jsx), so they render crisp at any size.
