    ...
    <div className="min-h-screen bg-white">
          ...
          <div className="grid grid-cols-2 sm:grid-cols-4 divide-x divide-gray-100">
            {STATS.map(({ num, label }) => (
              <div key={label} className="py-8 px-6 text-center">
                <p className="text-3xl font-bold text-gray-800 mb-1">{num}</p>
      ...
      <div className="max-w-5xl mx-auto px-6 sm:px-10 py-20">
        <div className="grid md:grid-cols-2 gap-16 items-start">
          ...
          {/* Left — text */}
          <div>
            <p className="text-xs font-bold tracking-widest uppercase mb-4" style={{ color: G }}>Our Story</p>
            <h2 className="text-2xl font-bold text-gray-800 mb-6 leading-tight">From a small flower shop to a name people trust</h2>
          ...
          <div className="flex flex-col items-center">
            <div className="relative w-full aspect-square rounded-xl overflow-hidden border border-gray-100 shadow-sm">
              <img
                src={STORY_SLIDES[slideIdx].img}
                alt={STORY_SLIDES[slideIdx].label}
            ...
            {/* Caption below image */}
            <p className="mt-3 text-xs text-gray-400 text-center italic leading-snug px-2">
      ...
      <div style={{ backgroundColor: "#F7F8FA" }}>
        <div className="max-w-5xl mx-auto px-6 sm:px-10 py-20">
          <p className="text-xs font-bold tracking-widest uppercase mb-3" style={{ color: G }}>What we stand for</p>
            ...
            {VALUES.map(({ title, desc, icon }) => (
              <div key={title} className="bg-white border border-gray-100 rounded-xl p-5">
                <div
                  ...
                  style={{ backgroundColor: "#F0F7F1", color: G }}
                >
                  {icon}
                </div>
