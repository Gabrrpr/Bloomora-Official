...
export default function TermsAndConditions({ onNavigate, onBack }) {
  ...
  // Text
  const bodyC     = isDark ? "#cbd5e1" : "#4b5563"   // clearly readable, not too faint
  const sectionHC = isDark ? "#f1f5f9" : "#1e293b"   // bright section headings
  ...
  const noteTxt = isDark ? "#fcd34d"               : "#92400e"  // brighter yellow in dark

  // SVG logo — invert to white in dark mode
  // brightness(0) → turns all pixels black, invert(1) → turns black to white
    ...
    <div className="min-h-screen" style={{ backgroundColor:pageBg }}>
      ...
      <div className="sticky top-0 z-10" style={{ backgroundColor:headerBg, borderBottom:`1px solid ${headerBdr}` }}>
        <div className="max-w-4xl mx-auto px-4 sm:px-6 py-4 flex items-center justify-between">
          ...
          {/* Logo — white in dark mode via CSS filter */}
      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 py-8 sm:py-12">
        <div className="rounded-2xl overflow-hidden"
          ...
          {/* Hero band — gradient always looks great */}
          <div style={{ background:`linear-gradient(135deg,${DG} 0%,${G} 100%)`, padding:"clamp(28px,6vw,48px) clamp(20px,5vw,40px)" }}>
            ...
            <h1 className="text-2xl sm:text-3xl font-bold text-white mb-2">Terms &amp; Conditions</h1>
            <p style={{ color:"rgba(255,255,255,0.72)", fontSize:"14px" }}>Bloomora Floral Management System</p>
          ...
          <div className="px-5 sm:px-8 py-8 sm:py-10 space-y-7">
            ...
            <div className="p-4 rounded-xl text-sm font-medium" style={{ backgroundColor:noteBg, border:`1px solid ${noteBdr}`, color:noteTxt }}>
              <strong>Please read these Terms carefully</strong> before using Bloomora's platform. By accessing or using our services, you agree to be bound by these terms.
            </div>
