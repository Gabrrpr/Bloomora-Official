...
import { SETTINGS_PATH, PRIVACY_KEY as KEY, DEFAULT_PRIVACY as FALLBACK } from "../../config/legalContent"

const G  = "#2E8B34"
const DG = "#0C573E"

export default function DataPrivacyPolicy({ onNavigate, onBack }) {
