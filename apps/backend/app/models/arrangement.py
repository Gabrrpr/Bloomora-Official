...
class Arrangement(Base):
    ...
    prompt_text = Column(Text, nullable=True)           # user's text description input
    generated_image_url = Column(String(500), nullable=True)  # Pollinations.ai output
    estimated_price = Column(Numeric(10, 2), nullable=True)

    # FK links to material entities
...
class Flower(Base):
    ...
    shelf_life_days = Column(Integer, nullable=True)    # flower care / expiration
