...
def send_otp_email(to_email: str, otp: str, first_name: str = None) -> bool:
    try:
        ...
        <body style="font-family: Arial, sans-serif; background-color: #f9f9f9; padding: 40px;">
            <div style="max-width: 480px; margin: auto; background: white; border-radius: 16px; padding: 40px; box-shadow: 0 2px 8px rgba(0,0,0,0.08);">
                <h2 style="color: #15803d; margin-bottom: 4px;">Bloomora</h2>
                ...
                <p style="color: #bbb; font-size: 12px; text-align: center;">Bloomora — Esting's Flowers International Inc.</p>
            </div>
        </body>
        </html>
        """
